...
function Footer() {
    ...
    return (
        <div>
            ...
            <div className="btn grid grid-cols-2  justify-start text-sm md:gap-x-15 ml-12 mr-12 md:ml-32 md:mr-36">
                <button className=" flex justify-self-start items-center justify-center text-pink-600 mt-4 font-bold ">Go Back</button>
